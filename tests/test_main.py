...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "Anna",
            "Tenet",
            'Cinema bar.py sold popcorn to Bob.\n'
        ...
        (
            ...
            "Anna",
            "Madagascar",
            'Cinema bar.py sold Coca-cola to Bob.\n'
            'Cinema bar.py sold popcorn to Alex.\n'
        ...
        (
            ...
            "Vasiliy",
            "Interstellar",
            'Cinema bar.py sold Pepsi to Susan.\n'
            'Cinema bar.py sold Coca-cola to Michael.\n'
            'Cinema bar.py sold popcorn to Monica.\n'
