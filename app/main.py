...
def cinema_visit(customers: list, hall_number: int, cleaner: str, movie: str) -> None:
    ...
    for customer_dict in customers:
        customer_instance = Customer(name=customer_dict["name"], food=customer_dict["food"])
        customers_instances_list.append(customer_instance)
        cinema_bar.sell_product(product=customer_instance.food, customer=customer_instance)
